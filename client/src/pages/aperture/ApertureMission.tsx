  ...
  return <DashboardLayout>
    <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
      <div>
        ...
        <p className="text-[0.68rem] font-semibold uppercase tracking-[0.16em]" style={{ color: "var(--sh-signal)" }}>Capital Aperture · new mission</p>
        <h1 className="mt-1 font-serif text-3xl leading-tight" style={{ color: "var(--sh-text-primary)" }}>Build one play slate.</h1>
        <p className="mt-2 text-sm" style={{ color: "var(--sh-fg-muted)" }}>Set the decision once. Research opens on the next screen.</p>
      </div>
    </div>
    <DecisionRunway
