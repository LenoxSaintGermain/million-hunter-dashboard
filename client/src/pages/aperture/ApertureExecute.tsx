  ...
  return (
    <DashboardLayout>
      <div className="mx-auto w-full min-w-0 max-w-5xl space-y-6 overflow-x-clip">
        ...
        <Tabs id="paper-lifecycle" defaultValue="orders" className="min-w-0 scroll-mt-24">
