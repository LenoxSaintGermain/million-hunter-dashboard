...
import { AlertTriangle, Play, Plus, RefreshCw, Trash2, BookOpen, TrendingUp, BarChart3 } from "lucide-react";
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button variant="outline" size="sm" onClick={() => navigate("/aperture/thesis/new")}>
