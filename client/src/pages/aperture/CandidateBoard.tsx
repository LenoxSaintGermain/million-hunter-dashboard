...
export function EvidenceQuestionReview({ symbol, checkLabel, draft, pending, now, onChange, onReview }: {
  ...
  return <section aria-label="Review evidence" className="space-y-3">
    ...
    <div className="flex flex-wrap gap-2">
      <Button type="button" size="sm" className="min-h-11" aria-describedby="evidence-answer-readiness" disabled={pending || !readiness.canResolve} onClick={() => answer("confirmed")}>Confirmed · clear this gate</Button>
      <Button type="button" variant="outline" size="sm" className="min-h-11" disabled={pending || tooLong} onClick={() => answer("not_confirmed")}>Not confirmed · decline paper stage</Button>
      <Button type="button" variant="outline" size="sm" className="min-h-11" aria-describedby="evidence-answer-readiness" disabled={pending || !readiness.canResolve} onClick={() => answer("not_applicable")}>Not applicable</Button>
      <Button type="button" variant="ghost" size="sm" className="min-h-11" disabled={pending || tooLong} onClick={() => answer("needs_follow_up")}>Need more evidence</Button>
    </div>
  </section>;
}
