      ...
      {headroomExhausted && (
        <div className="mt-3 rounded-lg border p-3 text-xs space-y-2" style={{ borderColor: "var(--sh-border-1)", background: "var(--sh-surface-2)" }}>
          <p className="font-semibold text-[11px] uppercase tracking-wider text-amber-500">
            What limits this trade
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 pt-1 text-[11px]">
            <div className="rounded p-2.5 border" style={{ borderColor: "var(--sh-border-1)", background: "var(--sh-surface)" }}>
              <p className="font-medium text-muted-foreground">1. Broker cash</p>
              <p className="mt-0.5 font-semibold">Not assessed here</p>
              <p className="mt-0.5 text-[10px] text-muted-foreground">Check the current account snapshot</p>
            </div>
            ...
            <div className="rounded p-2.5 border" style={{ borderColor: "var(--sh-border-1)", background: "var(--sh-surface)" }}>
              ...
              <p className="mt-0.5 text-[10px] text-muted-foreground">Subject to account risk limits</p>
            </div>
          </div>
