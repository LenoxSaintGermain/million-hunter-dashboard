...
vi.mock("@/lib/trpc", () => {
  ...
  return { trpc: {
    ...
    aperture: { run: { get: { useQuery: () => ({ data: { run: { id: 690001, status: "completed" }, candidates: [fixture.candidate], evidenceReviews: [], macroFacts: [], thesisContext: null }, isLoading: false, refetch: fixture.refetch }) }, retry: mutation, followUp: mutation, evidence: { review: mutation, refreshFinancialFacts: mutation, batchClearStandardGates: mutation, factDraft: { useQuery: () => ({ data: undefined, isFetching: false, refetch: fixture.refetch }) } } }, macro: { refresh: mutation }, generateMemo: mutation },
  } };
});
