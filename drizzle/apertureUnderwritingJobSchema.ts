...
export const apertureUnderwritingJobs = mysqlTable("aperture_underwriting_jobs", {
  ...
  request: json("request").$type<{ objective: CapitalObjective; requestedPlayCount: 1 | 2 | 3; appendRevision: boolean; revisionRequestId?: string; illustrativeUatFixture?: boolean }>().notNull(),
