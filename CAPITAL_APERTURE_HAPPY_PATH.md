...
The orders were accepted by Alpaca Paper on **2026-08-16** and all six later reached `filled` status. A final read-only sync mirrored the seven current broker positions (the six-position research canvas plus the prior SPY residual) into Capital Aperture and updated synced cash to **$59,998.07**. No follow-on order was submitted.
